...
import hw_encapsulater.model.events.NotAllowedUsecaseC;
...
public class UsecaseC_NotAllowed {
    public static void main(String[] args) throws ClassNotFoundException, IOException, NamingException, JMSException, InterruptedException {
        ...
        /**
         * Instantiating NotAllowedUsecaseC:
         * Returns tag list which will trigger
         * our usecase C rule
         */

        NotAllowedUsecaseC usecase = new NotAllowedUsecaseC();
