...
import hw_encapsulater.model.events.NotAllowedUsecaseB;
...
public class UsecaseB_NotAllowed {
    public static void main(String[] args) throws ClassNotFoundException, IOException, NamingException, JMSException, InterruptedException {
        ...
        /**
         * Instantiating NotAllowedUsecaseB:
         * Returns a list of tags which will
         * trigger usecase B rule
         */

        NotAllowedUsecaseB usecase = new NotAllowedUsecaseB();
