...
import hw_encapsulater.model.events.UsecaseC;
...
public class UsecaseC_Allowed {
    public static void main(String[] args) throws ClassNotFoundException, IOException, NamingException, JMSException, InterruptedException {
        ...
        /**
         * Instantiating UsecaseC:
         * Will return a list of tags with a
         * certain combination
         */

        UsecaseC usecase = new UsecaseC();
