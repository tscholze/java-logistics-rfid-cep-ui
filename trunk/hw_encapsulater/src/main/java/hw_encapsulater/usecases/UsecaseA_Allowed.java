...
import hw_encapsulater.model.events.UsecaseA;
...
public class UsecaseA_Allowed {
    public static void main(String[] args) throws ClassNotFoundException, IOException, NamingException, JMSException, InterruptedException {
        ...
        /**
         * Instantiating UsecaseA:
         * May carry two items one must be a Gummibaerchen
         * UsecaseA returns a list of tags (gummibaerchen,
         * one other and PersonA
         */

        UsecaseA usecase = new UsecaseA();
