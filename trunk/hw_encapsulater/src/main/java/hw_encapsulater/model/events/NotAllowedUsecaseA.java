 ...
 * However this class is written so that we do NOT have a Gummibaerchen
 * in our list which means that our rules should trigger
 *
 * @author Felix Wagner
 *
 */
...
public class NotAllowedUsecaseA extends GenericTestModel{
	@Override
