 ...
 * the same
 * However this only contains one pair and a single Snickers which
 * means that our rules trigger
 *
 * @author Felix Wagner
 *
 */
...
public class NotAllowedUsecaseB extends GenericTestModel{
	@Override
    ...
    public void initializeTagList() {
    	...
    	List<String> snickers = Arrays.asList(snick.getOneSnickers());
