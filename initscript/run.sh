...
function start() {
    ...
    # run hw encapsulator
    xterm -e "cd ~/ss12rfid/trunk/hw_encapsulater/target; java -jar hw_encapsulater-1.0-jar-with-dependencies.jar" &
    #xterm -e "cd ~/ss12rfid/trunk/hw_encapsulater/target; java -cp hw_encapsulater-1.0-jar-with-dependencies.jar hw_encapsulater.StartLightBarrier " &
